...
| `test_interruption.py` | 打断功能测试 | ⭐⭐ 中等 | 3️⃣ 打断测试 |
| `test_real_multithread_cascade.py` | 多线程并发测试 | ⭐⭐⭐ 复杂 | 4️⃣ 高级测试 |
| `benchmark_performance.py` | 性能基准测试 | ⭐⭐⭐ 复杂 | 5️⃣ 性能分析 |
...
- InterruptionManager 单元测试
  - 初始状态测试
  - 状态转换测试（IDLE ↔ COLLECTING）
  - 外部状态设置测试
  - COLLECTING状态下拒绝外部切换
  - PROCESSING/RESPONDING状态下的打断触发
  - 最小间隔检查
  - 禁用打断功能测试
...
# 打断功能测试
python tests/test_interruption.py -v || exit 1
